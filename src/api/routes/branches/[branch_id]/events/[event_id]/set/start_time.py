...
guard = perm_guard("event.update.start_time")
...
def post(body: dict, event_id: str = "", branch_id: str = ""):
    ...
    start_time = body["start_timestamp"]
    start_datetime_obj = datetime.fromtimestamp(start_time)
    ...
    try:
        ...
        event.set_start_time(start_datetime_obj)
